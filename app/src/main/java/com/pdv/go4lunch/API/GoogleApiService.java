...
public interface GoogleApiService {
    ...
    @GET("maps/api/place/details/json?&fields=place_id,name,rating,geometry,formatted_phone_number,formatted_address,vicinity,types,photos,website,opening_hours")
    Call<Place> getPlace(
